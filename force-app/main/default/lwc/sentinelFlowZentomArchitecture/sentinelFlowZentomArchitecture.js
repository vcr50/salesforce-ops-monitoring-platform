...
const ENGINES = [
    ...
    { id: 'router', icon: '🔀', title: 'Model Router', desc: 'Selects the optimal AI model combination based on task type, risk level, latency, and confidence needs.', tags: 'R1 · Coder · Llama 3 · Salesforce Native', color: '#7b52ff' }
];
...
const GATES = [
    ...
    { id: 'g5', num: '5', title: 'Execution', desc: 'The Execution Controller manages pre-execution checks, sequencing, and step verification before dispatching via Salesforce Native.', rules: [{ text: 'Circuit breaker check', tone: 'escalate' }, { text: 'Step-by-step verify', tone: 'pass' }, { text: 'Rollback on failure', tone: 'pass' }] }
];
