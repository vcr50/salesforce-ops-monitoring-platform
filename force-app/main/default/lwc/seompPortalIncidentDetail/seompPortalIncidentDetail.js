...
import getIncidentDetail from '@salesforce/apex/SEOMPPortalController.getIncidentDetail';

export default class SeompPortalIncidentDetail extends LightningElement {
    recordId;
    detail;
    error;
