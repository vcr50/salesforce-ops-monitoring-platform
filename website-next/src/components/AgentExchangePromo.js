      ...
      <div className="container promo-container">
        <div className="promo-content">
          ...
          <div className="promo-actions">
            ...
            <a href="https://login.salesforce.com/packaging/installPackage.apexp?p0=04tdL000000c4aTQAQ" target="_blank" rel="noopener noreferrer" className="btn btn-outline btn-lg">Get Package (2GP)</a>
          </div>
        </div>
